...
<table cellpadding="10" cellspacing="0" border="0">
    ...
    <tr>
      ...
      <tr>
        <!-- Bedrock Minecraft -->
        <td>
            <img src="apps/bedrock-minecraft/icon.svg" width="100">
        </td>
        <td>
            <b>Bedrock Minecraft</b><br>
            <i><a href="https://minecraft.wiki/w/File:Bedrock_Edition_App_Store_icon_1.png">Icon</a> in the Public Domain.</i>
        </td>
        <!-- Command Prompt -->
        <td>
